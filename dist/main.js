!function () {
    ...
    !function (e) {
        ...
        })), e(".share-outer").click((() => e(".share-wrap").fadeToggle())), e("img.lazy").lazyload({effect: "fadeIn"}), e("#gallery").justifiedGallery({
            rowHeight: 200,
            margins: 5
        ...
        var o = window, s = document, r = e,
            ...
            n = s.createElement("script"), c = s.getElementsByTagName("script")[0];
    ...
    (() => {
        ...
        "" === a || /^(http:|https:)?\/\//.test(a) || (a = window.location.origin + a), e.forEach((e => {
            e.onclick = o => {
                s(e.getAttribute("data-type"), {sUrl: t, sPic: a, sTitle: r, sDesc: r})
            }
